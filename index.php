    ...
    <div class=" row">
      ...
      <div class="col-2 border border-success">
        <div class="sticky-top">
          <div class="mt-4 pt-4">
            <div class="text-center fs-3 fw-semibold">Dompet</div>
            <div class="text-center fs-6 fw-lighter">Catatan dompet anda</div>
            <hr>
            <a href="index.php" type="button" class="btn text-decoration-none fs-5 py-3">
              <i class="bi bi-bar-chart-fill d-inline"></i>
              <p class="d-inline fw-light">Dashboards</p>
            </a>
            <a href="#" type="button" class="btn text-decoration-none fs-5 py-3">
              <i class="bi bi-credit-card-fill d-inline"></i>
              <p class="d-inline fw-light">View Transactions</p>
            </a>
          </div>
        </div>
      </div>
      <!-- Konten -->
      <div class="col-10 mt-4 pt-4">
        <div class="row">
          <!-- Pemasukan card -->
